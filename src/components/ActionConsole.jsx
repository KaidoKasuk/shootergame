  ...
  return (
    <div className="action-panel">
      ...
      <div className="console-log" ref={logRef}>
        <div className="console-prompt">game@{username}:~$</div>
        {log.map((entry) => (
        ...
        <div className="console-prompt">
          game@{username}:~$<span className="console-cursor">_</span>
        </div>
      </div>
      ...
      <div className="action-btns">
        ...
        <button className="action-btn" onClick={onShootEnemy} disabled={!canAct}>
          Shoot Enemy
        </button>
        <button className="action-btn" onClick={onSpinChamber} disabled={!canAct}>
          Spin Chamber
        </button>
      </div>
    </div>
